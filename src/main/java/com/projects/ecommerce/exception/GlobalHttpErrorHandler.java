...
public class GlobalHttpErrorHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<Object> handlerEmptyFieldException(EmptyFieldException exception) {
    ...
    public ResponseEntity<Object> handlerRecordNoExistsException(RecordNotExistsException exception) {
        return new ResponseEntity<>("Object with given id doesn't exist", HttpStatus.BAD_REQUEST);
    }

    @ExceptionHandler(RecordExistsException.class)
    public ResponseEntity<Object> handlerRecordExistsException(RecordExistsException exception) {
